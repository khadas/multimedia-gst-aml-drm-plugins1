...
#ifndef __GST_H264_SEC_PARSE_H__
#define __GST_H264_SEC_PARSE_H__
...
#define GST_TYPE_H264_SEC_PARSE \
  (gst_h264_sec_parse_get_type())
#define GST_H264_SEC_PARSE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_H264_SEC_PARSE,GstH264SecParse))
#define GST_H264_SEC_PARSE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_H264_SEC_PARSE,GstH264SecParseClass))
#define GST_IS_H264_SEC_PARSE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_H264_SEC_PARSE))
#define GST_IS_H264_SEC_PARSE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_H264_SEC_PARSE))

GType gst_h264_sec_parse_get_type (void);

typedef struct _GstH264SecParse GstH264SecParse;
typedef struct _GstH264SecParseClass GstH264SecParseClass;

struct _GstH264SecParse
{
